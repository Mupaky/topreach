...
export default function RecordingOrderView({ data }) {
						...
						<MaxWidthWrapper>
							...
							<div className="mt-10 grid grid-cols-2 lg:grid-cols-4 gap-5 relative">
								...
								<div className="flex flex-col gap-3">
									...
									<p className="text-lg font-[600] flex flex-col">
										<span>{formatDate(data.date)}</span>
										<span>
											{data.startHour}:00 - {data.endHour}
											:00
										</span>
									</p>
								</div>
								...
								<div className="flex flex-col gap-3">
									...
									<p className="text-lg font-[600]">
										{data.secondOperator == true
											? "Да"
											: "Не"}
									</p>
								</div>

								<div className="flex flex-col gap-3 col-span-2 lg:col-span-3">
									<h2 className="font-[600] text-neutral-400">
										Описание:
									</h2>
